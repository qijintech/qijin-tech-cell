...
import tech.qijin.cell.misc.db.mapper.MiscCityMapper;
import tech.qijin.cell.misc.db.mapper.MiscCitySqlProvider;
...
public interface MiscCityDao extends MiscCityMapper {

	@InsertProvider(type = SqlProvider.class, method = "batchInsert")
	int batchInsert(@Param("records") List<MiscCity> records);

	class SqlProvider {
		private static final String VALUES = "VALUES";
		MiscCitySqlProvider provider = new MiscCitySqlProvider();

		public String batchInsert(Map<String, Object> param) {
			List<MiscCity> records = (List<MiscCity>) param.get("records");
			return genSql(records);
		}

		private String genSql(List<MiscCity> records) {
