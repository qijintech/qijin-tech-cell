...
import tech.qijin.cell.misc.db.mapper.MiscTrackMapper;
import tech.qijin.cell.misc.db.mapper.MiscTrackSqlProvider;
...
public interface MiscTrackDao extends MiscTrackMapper {

	@InsertProvider(type = SqlProvider.class, method = "batchInsert")
	int batchInsert(@Param("records") List<MiscTrack> records);

	class SqlProvider {
		private static final String VALUES = "VALUES";
		MiscTrackSqlProvider provider = new MiscTrackSqlProvider();

		public String batchInsert(Map<String, Object> param) {
			List<MiscTrack> records = (List<MiscTrack>) param.get("records");
			return genSql(records);
		}

		private String genSql(List<MiscTrack> records) {
