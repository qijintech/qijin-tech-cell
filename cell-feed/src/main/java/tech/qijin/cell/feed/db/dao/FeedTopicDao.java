...
import tech.qijin.cell.feed.db.mapper.FeedTopicMapper;
import tech.qijin.cell.feed.db.mapper.FeedTopicSqlProvider;
...
public interface FeedTopicDao extends FeedTopicMapper {

	@InsertProvider(type = SqlProvider.class, method = "batchInsert")
	int batchInsert(@Param("records") List<FeedTopic> records);

	class SqlProvider {
		private static final String VALUES = "VALUES";
		FeedTopicSqlProvider provider = new FeedTopicSqlProvider();

		public String batchInsert(Map<String, Object> param) {
			List<FeedTopic> records = (List<FeedTopic>) param.get("records");
			return genSql(records);
		}

		private String genSql(List<FeedTopic> records) {
