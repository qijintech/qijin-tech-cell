...
import tech.qijin.cell.feed.db.model.FeedInteractionExample.Criteria;
import tech.qijin.cell.feed.db.model.FeedInteractionExample.Criterion;
import tech.qijin.cell.feed.db.model.FeedInteractionExample;

public class FeedInteractionSqlProvider {

    public String countByExample(FeedInteractionExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("feed_interaction");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(FeedInteractionExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("feed_interaction");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(FeedInteraction record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("feed_interaction");
    ...
    public String selectByExample(FeedInteractionExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        FeedInteraction record = (FeedInteraction) parameter.get("record");
        FeedInteractionExample example = (FeedInteractionExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("feed_interaction");
    ...
    public String updateByPrimaryKeySelective(FeedInteraction record) {
        SQL sql = new SQL();
        sql.UPDATE("feed_interaction");
    ...
    protected void applyWhere(SQL sql, FeedInteractionExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
