...
import tech.qijin.cell.feed.db.mapper.FeedByGroupMapper;
import tech.qijin.cell.feed.db.mapper.FeedByGroupSqlProvider;
...
public interface FeedByGroupDao extends FeedByGroupMapper {

	@InsertProvider(type = SqlProvider.class, method = "batchInsert")
	int batchInsert(@Param("records") List<FeedByGroup> records);

	class SqlProvider {
		private static final String VALUES = "VALUES";
		FeedByGroupSqlProvider provider = new FeedByGroupSqlProvider();

		public String batchInsert(Map<String, Object> param) {
			List<FeedByGroup> records = (List<FeedByGroup>) param.get("records");
			return genSql(records);
		}

		private String genSql(List<FeedByGroup> records) {
