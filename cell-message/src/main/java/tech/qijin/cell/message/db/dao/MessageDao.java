...
import tech.qijin.cell.message.db.mapper.MessageMapper;
import tech.qijin.cell.message.db.mapper.MessageSqlProvider;
...
public interface MessageDao extends MessageMapper {
	...
	class SqlProvider {
		...
		MessageSqlProvider provider = new MessageSqlProvider();

		public String batchInsert(Map<String, Object> param) {
			List<Message> records = (List<Message>) param.get("records");
			return genSql(records);
		}

		private String genSql(List<Message> records) {
