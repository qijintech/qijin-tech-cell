...
import tech.qijin.cell.message.db.model.FeedbackExample.Criteria;
import tech.qijin.cell.message.db.model.FeedbackExample.Criterion;
...
public class FeedbackSqlProvider {
    ...
    protected void applyWhere(SQL sql, FeedbackExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
